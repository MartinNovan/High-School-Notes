...
## Vysvětlivky jednotlivých pojmů
...
- ![](Obrazky/Variable_in_memory.png)
...
- ![](Obrazky/Element_shifting_in_array.png)
...
- ![](Obrazky/Linked_list_in_memory.png)
...
- ![](Obrazky/Double_linked_list.png)
---
...
- ![](Obrazky/Singly_circular_linked_list.png)
- Níže uvedený obrázek je příkladem dvojitého kruhového spojené seznamu:
- ![](Obrazky/Doubly_circular_linked_list.png)
#### **Výhody:**
- dynamická velikost
...
![](Obrazky/Stack_data_structure.png)
...
##### Zásobník vytvořený propojeným seznamem
...
- ![](Obrazky/Queue_data_structure.png)
...
##### Fronty vytvořený propojeným seznamem
...
##### Vytvoření hash tabulky od základů
...
###### Uložíme jména pomocí hash funkce
...
###### Vyhledáme prvek pomocí hash funkce
...
###### Základní příklad kódu hash sady a simulace
...
#### Terminologie stromů a pravidla
...
- **Vyvážený binární strom** má maximálně 1 rozdíl mezi výškou levého a pravého podstromu pro každý uzel ve stromu.
	- ![](Obrazky/Binary_tree_balanced.png)
...
- **Dokonalý binární strom** má všechny listové uzly na stejné úrovni, což znamená, že všechny úrovně jsou plné uzlů a všechny vnitřní uzly mají dva podřízené uzly. Vlastnosti dokonalého binárního stromu znamenají, že je také plný, vyvážený a úplný.
	- ![](Obrazky/Binary_tree_perfect.png)
...
- ![](Obrazky/Binary_tree_pre-order_traversal.gif)
...
- ![](Obrazky/Binary_tree_in-order_traversal.gif)
...
- ![](Obrazky/Binary_tree_post-order_traversal.gif)
...
- ![](Obrazky/Binary_search_tree.png)
...
- ![](Obrazky/BST_balanced_and_unbalanced.png)
...
- ![](Obrazky/BST_find_lowest_value.gif)
...
- ![](Obrazky/BST_deleting_nodes.gif)
...
##### Znázornění grafu pomocí sousední matice (Adjacency Matrix Graph Representation)
...
- ![](Obrazky/Graph_directed_adjacency_matrix.png)
...
##### Zobrazení grafu pomocí seznamů sousedství
...
- ![](Obrazky/Graph_undirected_adjacency_list.png)
...
- ![](Obrazky/Graph_directed_adjacency_list.png)
...
```
#### Implementace grafů za pomocí tříd
...
###### Procházení metodou prohledávání do hloubky prohledávání
...
```
###### Procházení metodou prohledávání do šířky prohledávání
...
- topologické třídění
---
## Tabulka časových složitostí (Big O)
